        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, idx) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="backdrop-blur bg-white/5 border border-white/10 rounded-xl shadow-2xl p-7 flex flex-col hover:scale-105 hover:border-blue-400 hover:shadow-blue-500/20 transition-all duration-300 group relative overflow-hidden h-full"
            >
